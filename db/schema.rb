...
ActiveRecord::Schema.define(version: 2022_01_19_004902) do
  ...
  create_table "ninjas", force: :cascade do |t|
    ...
    t.string "sex"
    t.integer "position"
    t.index ["event_id"], name: "index_ninjas_on_event_id"
  end
  ...
  create_table "picks", force: :cascade do |t|
    ...
    t.index ["ninja_id"], name: "index_picks_on_ninja_id"
  ...
  add_foreign_key "ninjas", "events"
  add_foreign_key "picks", "events"
  add_foreign_key "picks", "ninjas"
